    ...
    <div class="create-post">
        ...
        <div class="create-post-container">
            ...
            <div class="blog-action">
                ...
                <router-link class="router-button" to="/blog-preview">Post Preview</router-link>
            </div>
        </div>
    </div>
</template>
                ...
                if (this.file) {
                    ...
                    docRef.put(this.file).on("state_changed", (snapshot) => {
                        ...
                        async () => {
                            ...
                            this.loading = false
                            this.$router.push("/blog-view/"+dataBase.id)
                        }
                    )
                    return
                }
                this.error = true
                this.errorMsg = " Please select a cover photo";
                setTimeout(() => {
                    this.error = false
                    this.errorMsg = ""
                }, 5000)
